    ...
    <main className="min-h-screen bg-gray-50 px-4 py-10">
      <div className="mx-auto max-w-3xl space-y-8 rounded-lg bg-white p-6 shadow">
        <header className="space-y-1 border-b border-gray-200 pb-4">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">Revisar assinatura</h1>
          <p className="text-sm text-gray-500 mt-2">
            Você está criando uma assinatura mensal. O pagamento será cobrado automaticamente todo mês.
          </p>
        </header>
