      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-51 min-[1501px]:hidden"
          />
        )}
      </AnimatePresence>
      <aside
        ...
        min-[1501px]:translate-x-0
      `}
      >
        <div className="min-[1501px]:hidden absolute top-4 right-4">
                ...
                <div className="mt-1 space-y-1 px-2">
                  {module.lessons
                    ...
                    ?.map((lesson: any) => {
                      ...
                      const isCompleted = data?.completedLessons?.includes(
                        lesson.id,
                      );
