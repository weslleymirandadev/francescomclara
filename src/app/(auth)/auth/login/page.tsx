    ...
    <div className="min-h-screen flex flex-col items-center relative overflow-hidden font-sans bg-white animate-in fade-in duration-700">
      <div className="absolute top-0 left-0 w-full h-[45vh] z-0 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=2073')",
          }}
        />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-20">
        <div className="absolute -bottom-10 -left-10 flex items-end">
          <img
            ...
            className="w-20 h-20 md:w-56 md:h-56 opacity-100 -rotate-12 -translate-y-5 md:translate-y-10"
            alt=""
          />
          <img
            src="/static/flower.svg"
            className="w-16 h-16 md:w-32 md:h-32 opacity-100 animate-[spin_80s_linear_infinite] -translate-x-16 md:-translate-x-12"
            alt=""
          />
        </div>
        <div className="absolute -bottom-10 -right-10 flex items-end">
          ...
          <img
            src="/static/flower.svg"
            className="w-16 h-16 md:w-32 md:h-32 opacity-100 animate-[spin_70s_linear_infinite_reverse] -translate-x-12 md:-translate-x-8"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="w-full h-[32vh] relative flex flex-col items-center justify-center z-30">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl font-black uppercase tracking-[0.2em] text-slate-900 drop-shadow-sm">
            Área do <span className="text-[#002395]">Alu</span>
            <span className="text-[#ED2939]">no</span>
          </h1>
          <div className="mt-4 flex items-center justify-center gap-2">
            <span className="h-px w-8 bg-slate-300"></span>
            <p className="text-[11px] font-black uppercase tracking-[0.5em] text-slate-800">
              Francês com{" "}
              <span className="text-(--clara-rose) italic">Clara</span>
            </p>
            <span className="h-px w-8 bg-slate-300"></span>
          </div>
        </div>
      ...
      <div className="w-full max-w-[480px] px-6 -mt-6 relative z-50">
        <div className="bg-white p-10 md:p-14 rounded-[3rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] border border-slate-100 relative">
          ...
          <div className="mb-10 text-center">
            <h2 className="text-[11px] font-black uppercase tracking-[0.4em] text-slate-900">
              Acesse sua Trilha
            </h2>
          </div>
          ...
          <div className="relative my-10">
            ...
            <div className="relative flex justify-center text-[10px] uppercase font-black text-slate-400 bg-white px-4 tracking-[0.3em]">
              Ou continuar com
            </div>
          </div>
          ...
          >
            <FaGoogle
              className="text-slate-400 group-hover:text-(--clara-rose) transition-colors"
              size={18}
            />
            <span className="text-[11px] font-black uppercase tracking-widest text-slate-700 group-hover:text-(--clara-rose) transition-colors">
              Google Account
            </span>
          </button>
        </div>
