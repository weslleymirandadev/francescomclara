        ...
        <div className="space-y-6">
          <Card className="p-8 border-none bg-linear-to-br from-clara-rose to-s-800 text-white shadow-xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <Button 
                type='button'
                className="w-full bg-white text-clara-rose hover:bg-s-50 border-none font-black text-xs tracking-widest py-6 shadow-md transition-all active:scale-95 cursor-pointer"
