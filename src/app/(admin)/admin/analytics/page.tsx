    ...
    <div className="min-h-screen bg-white">
      <div className="p-4 md:p-10 max-w-7xl mx-auto w-full space-y-6 md:space-y-10">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-b border-(--color-s-100) pb-6 md:pb-8 gap-4">
          ...
          <button
            type="button"
            className="w-full sm:w-auto bg-s-900 text-white px-5 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 shadow-sm hover:bg-interface-accent transition-all active:scale-95 cursor-pointer"
              ...
              data.recentStudents.map((student) => (
                <div key={student.id} className="flex items-center justify-between p-4 md:p-6 md:px-10 hover:bg-s-50/30 transition-all group">
                  ...
                  <Link 
                    ...
                    key={student.id} 
                    className="flex items-center justify-between p-4 md:p-6 md:px-10 hover:bg-s-50/30 transition-all group cursor-pointer"
                  >
                    <div className="text-right shrink-0 flex items-center gap-4">
                      ...
                      <ArrowRight size={16} className="text-s-200 group-hover:text-interface-accent" />
                    </div>
                  </Link>
                </div>
              ))
