    ...
    <div className="w-full bg-white min-h-screen">
      <div className="p-4 md:p-10 max-w-6xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {plans.map((plan) => (
            <div key={plan.id} className="bg-white border-2 border-slate-100 rounded-[2rem] p-6 hover:border-[var(--interface-accent)] transition-all group relative overflow-hidden">
              ...
              <div className="mb-6">
                ...
                {plan.period === 'YEARLY' && (
                  <p className="text-[10px] text-[var(--interface-accent)] font-bold uppercase mt-1">
              ...
              <ul className="space-y-3 mb-8">
                {plan.features.slice(0, 3).map((feature, i) => (
                  <li key={i} className="flex items-center gap-2 text-xs text-slate-500 font-medium">
                    <div className="w-1.5 h-1.5 rounded-full bg-[var(--interface-accent)]" />
                    {feature}
                  </li>
                ))}
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <p className="text-[10px] font-bold text-[var(--interface-accent)] italic">
              ...
              <div className="space-y-2">
                ...
                <Button variant="ghost" onClick={addFeature} className="w-full text-[10px] font-black uppercase text-slate-400 hover:text-[var(--interface-accent)] cursor-pointer">
                  + Adicionar Vantagem
                </Button>
              </div>
            </div>
