      ...
      <div className="max-w-4xl mx-auto pt-20 text-center">
        <div className="bg-white p-12 rounded-md md:rounded-3xl shadow-sm border border-slate-100">
          ...
          <p className="text-slate-500 font-medium">
            Volte mais tarde ou complete novas lições para gerar mais
            flashcards.
          </p>
        </div>
      </div>
    ...
    <div className="max-w-4xl mx-auto pt-10 pb-20">
      <div className="flex items-center justify-between mb-8 px-4">
        <button
          ...
          className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-slate-600 transition-colors cursor-pointer"
        >
      ...
      {mode === "IDLE" && (
        <div className="bg-white p-10 rounded-md md:rounded-3xl shadow-sm border border-slate-100 text-center">
          ...
          <button
            ...
            className="px-10 py-4 bg-slate-900 text-white rounded-md md:rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-slate-800 transition-all shadow-lg shadow-slate-200 cursor-pointer"
          >
            Começar Revisão
          </button>
        </div>
      ...
      {mode === "STUDY" && currentCard && (
        <div className="perspective-1000 w-full max-w-2xl mx-auto px-4">
          ...
          >
            ...
            >
              <span className="text-[10px] font-black text-(--interface-accent) uppercase tracking-[0.2em] mb-4">
                Francês
              </span>
              <h2 className="text-4xl md:text-5xl font-black text-slate-800 tracking-tighter lowercase">
                {currentCard.front}
              </h2>
              <p className="absolute bottom-10 text-[9px] font-black text-slate-300 uppercase tracking-widest">
            ...
            >
              <div className="w-full flex flex-col items-center justify-center">
                <span className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-4">
                  Português
                </span>
            ...
            {isFlipped && (
              ...
              >
                <button
                  ...
                  className="py-4 bg-red-50 text-red-500 font-black uppercase tracking-widest text-[11px] rounded-2xl border-2 border-red-100 hover:bg-red-100 transition-colors cursor-pointer"
                >
                  Ainda não sei
                </button>
                <button
                  ...
                  className="py-4 bg-emerald-50 text-emerald-600 font-black uppercase tracking-widest text-[11px] rounded-2xl border-2 border-emerald-100 hover:bg-emerald-100 transition-colors cursor-pointer"
                >
                  Já sabia!
                </button>
              </motion.div>
      ...
      {mode === "DONE" && (
        <div className="bg-white p-12 rounded-md md:rounded-3xl shadow-sm border border-slate-100 text-center">
          ...
          <p className="text-slate-500 mb-8 font-medium">
            Você revisou {cards.length} termos hoje.
          </p>
          ...
          <div className="flex gap-4 max-w-xs mx-auto mb-8">
            <div className="flex-1 bg-emerald-50 p-4 rounded-md md:rounded-2xl border border-emerald-100">
              ...
              <div className="text-[9px] font-black text-emerald-600/60 uppercase">
                Acertos
              </div>
            </div>
            <div className="flex-1 bg-red-50 p-4 rounded-md md:rounded-2xl border border-red-100">
              ...
              <div className="text-[9px] font-black text-red-500/60 uppercase">
                Erros
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="px-8 py-4 bg-slate-900 text-white rounded-md md:rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-slate-800 transition-all cursor-pointer"
          >
            Voltar ao Dashboard
          </button>
        </div>
