        ...
        >
          ...
          <span className="font-bold text-lg tracking-tight text-(--slate-800) uppercase flex items-center">
            ...
            <span
              ...
              style={{
                color: `var(${settings?.highlightColor || "--clara-rose"})`,
              }}
            >
              Clara
                  ...
                  <Icon
                    ...
                    className={
                      isActive
                        ...
                        : "text-(--slate-400) group-hover:text-(--interface-accent)"
                    }
                  />
                  <span
              ...
              <div className="relative group">
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white shadow-2xl rounded-[1.5rem] p-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all border border-slate-100 z-50">
                  ...
                  >
                    ...
                    <span className="text-sm">Conta e Segurança</span>
                  </Link>
                  ...
                  {session?.user?.role === "MODERATOR" && (
                    ...
                    >
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-(--interface-accent)">
                        Moderação
                      </span>
                    </Link>
                  )}
        ...
        <div className="md:hidden bg-white border-t p-6 space-y-3 shadow-2xl animate-in slide-in-from-top duration-300">
          ...
          {session && (
            <div>
              ...
              >
                <User size={20} className="text-(--clara-rose)" />{" "}
              ...
              >
                <HiOutlineCog size={20} className="text-(--clara-rose)" />{" "}
          ...
          {session?.user?.role === "ADMIN" && (
            <Link
              href="/admin"
              className="flex items-center gap-2 p-4 hover:bg-slate-50 rounded-xl transition-all"
              onClick={() => {
                setIsMobileMenuOpen(false);
                setIsRedirecting(true);
                router.push("/admin");
          ...
          {session?.user?.role === "MODERATOR" && (
            ...
            >
              <FiMessageSquare className="text-(--interface-accent)" />
              <span className="text-xs font-black uppercase tracking-widest text-(--interface-accent)">
                Moderação
              </span>
            </Link>
          )}
          ...
          {session ? (
            ...
            <Link
              href="/auth/login"
              className="flex items-center justify-center p-4 font-black text-[11px] uppercase tracking-widest text-white bg-(--interface-accent) rounded-2xl"
            >
              Entrar
            </Link>
          )}
