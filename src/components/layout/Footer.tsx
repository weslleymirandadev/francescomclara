        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              ...
              <span className="font-bold text-lg tracking-tight text-slate-800 uppercase flex items-center">
                ...
                <span
                  className="relative ml-1 inline-flex items-center" // inline-flex ajuda a travar o tamanho
                  style={{
                ...
                >
                  ...
                  {/* O segredo: usei leading-none e mudei os negativos para não vazarem tanto */}
                  <span className="absolute -top-1 -right-3 text-sm leading-none select-none pointer-events-none transition-transform group-hover:rotate-15">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-semibold text-slate-600">
              ...
              <div className="h-px bg-slate-100 w-8 my-2" />
              <li>
                <Link
                  href="/privacidade"
                  className="hover:text-(--interface-accent) transition-colors"
