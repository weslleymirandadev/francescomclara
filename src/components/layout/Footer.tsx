        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              ...
              />
              <span className="font-bold text-lg tracking-tight text-color-s-800 uppercase flex items-center">
                ...
                >
                  ...
                  <span className="absolute -top-0.5 -right-2.5 text-sm inline-block rotate-35deg transition-transform group-hover:rotate-15deg">
                    {settings?.siteIcon ? (
                      <img
                        ...
                        onError={(e) => {
                          ...
                          e.currentTarget.parentElement!.innerHTML = `<span>${settings.siteIcon}</span>`;
                        }}
                      />
                    ) : (
                      <img
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-semibold text-(--slate-600)">
              <li>
                <Link
                  href="/dashboard"
                  className="hover:text-(--interface-accent) transition-colors"
                >
                  Dashboard
                </Link>
              </li>
            ...
            <ul className="space-y-4 text-sm font-semibold text-(--slate-600)">
              <li>
                <a
                  ...
                  className="hover:text-(--interface-accent) transition-colors flex flex-col"
                >
                  <span className="text-[10px] text-s-400 uppercase tracking-tighter">
                    E-mail de Suporte
                  </span>
